...
#if ART_USE_MMTK
            gc::third_party_heap::ThirdPartyHeap* tp_heap = runtime->GetHeap()->GetThirdPartyHeap();
            tp_heap->SetImageSpace(reinterpret_cast<uintptr_t>(image_space->Begin()), image_space->Size());
#endif  // ART_USE_MMTK
          }
          {
...
#if ART_USE_MMTK
              gc::third_party_heap::ThirdPartyHeap* tp_heap = runtime->GetHeap()->GetThirdPartyHeap();
              tp_heap->RemoveImageSpace(reinterpret_cast<uintptr_t>(image_space->Begin()), image_space->Size());
#endif  // ART_USE_MMTK
            }
