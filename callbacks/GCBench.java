// [k-sareen]: For LICENSE see LICENSE-GCBench
// [k-sareen]: Modify GCBench to support iterations and using the AndroidCallback
//
...
public class GCBench {
	...
	static void TimeConstruction(int depth) {
		...
		PrintDiagnostics();
		System.out.println("PASSED in " + tElapsed + "ms.");
        }

	public static void main(String args[]) {
		int	iterations = 5;
		AndroidCallback	cb = new AndroidCallback();
                if (args.length > 1) {
                  if (args[0].equals("-n")) {
                    try {
                      iterations = Integer.parseInt(args[1]);
                    } catch (Exception e) {
                      System.err.println("Can't parse number of iterations! Using default iterations = 5");
                      iterations = 5;
                    }
                  }
                }
